...
int main()
{
    ...
    float Population_Densinty = (Population / Area);
    float Population_Desinty2 = (Populations2 / Area2);
    float PibPerCapita = (Pib / Population);
    float PibPerCapita2 = (Pib2 / Populations2);
    ...
    printf("The population density is %.2lf \n", Population_Densinty);
    printf("The Pib per Capita is %.2lf \n", PibPerCapita);
